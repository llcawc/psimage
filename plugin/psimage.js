 ...
 */
export default function gulpImg(mozjpegOptions = { quality: 75, progressive: true }, optipngOptions = { optimizationLevel: 5 }, svgoOptions = { plugins: [{ name: 'preset-default', params: { overrides: { removeViewBox: false } } }] }, silent = false, verbose = true) {
    let totalBytes = 0;
